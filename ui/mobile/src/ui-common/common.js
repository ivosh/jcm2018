...
export const API_ADD_POZNAMKA = 'addPoznamka';
export const API_DELETE_POZNAMKA = 'deletePoznamka';
...
export const API_MODIFY_POZNAMKA = 'modifyPoznamka';
...
export const API_SAVE_POZNAMKY = 'savePoznamky';
